  ...
  return (
    <div className="flex justify-between relative">
      <div className="bg-primary sm:px-20 sm:py-16 p-10 rounded-3xl w-full">
        ...
        <h2 className="font-primary text-white sm:text-4xl text-2xl font-bold leading-snug sm:w-3/5 w-full text-center lg:text-left py-2">
        ...
        <div className="flex space-4 gap-4 items-center">
          ...
          <Image className="cursor-pointer" src="/appleStore2.svg" height={100} width={130} />
        </div>
      </div>
